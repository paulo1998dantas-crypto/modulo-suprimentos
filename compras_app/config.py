...
OS_PROCESSO_RELACOES_FILE = os.path.join(DATA_DIR, "os_relacoes_processo_item.json")
OS_ITEM_POPUP_REGRAS_FILE = os.path.join(DATA_DIR, "os_regras_popup_item.json")
